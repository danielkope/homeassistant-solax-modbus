...
def value_function_mid_status(value: int, _descr: Any, _data: dict[str, Any]) -> str:
    """Decode Protocol II state without hiding unrecognized firmware values."""
    return {0: "Waiting", 1: "Normal", 3: "Fault"}.get(value, f"Unknown ({value})")


def value_function_mid_derating(value: int, _descr: Any, _data: dict[str, Any]) -> str:
    """Keep reserved/undocumented derating reasons observable."""
    return {
        0: "No derating",
        1: "PV input",
        3: "Grid voltage",
...
# Read-only MID four-MPPT telemetry. Growatt Modbus RTU v1.24, pp.47-52.
# Verified on MID 36KTL3-X / DM1.0. Do not apply this map to GEN4 hybrids.
# String connector pairs 1/2, 3/4, 5/6, 7/8 correspond to MPPT1..4;
# a disconnected bit can simply mean an unused connector, not a system fault.
MID_GEN2_TELEMETRY: list[GrowattModbusSensorEntityDescription] = [
    GrowattModbusSensorEntityDescription(
        name="MID Operating Status",
        key="mid_operating_status",
        register=0,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
        scale=value_function_mid_status,
    ),
    GrowattModbusSensorEntityDescription(
        name="MID Derating Reason",
        key="mid_derating_reason",
        register=104,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
        scale=value_function_mid_derating,
    ),
    GrowattModbusSensorEntityDescription(
        name="MID Fault Main Code",
        key="mid_fault_main_code",
        register=105,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID Fault Subcode",
        key="mid_fault_subcode",
        register=107,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID Warning Bits High",
        key="mid_warning_bits_high",
        register=110,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID Warning Subcode",
        key="mid_warning_subcode",
        register=111,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID Warning Main Code",
        key="mid_warning_main_code",
        register=112,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String Mismatch Mask",
        key="mid_string_mismatch_mask",
        register=174,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String Current Imbalance Mask",
        key="mid_string_current_imbalance_mask",
        register=175,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String Disconnected Mask",
        key="mid_string_disconnected_mask",
        register=176,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID Line Voltage L1 L2",
        key="mid_line_voltage_l1_l2",
        register=50,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID Line Voltage L2 L3",
        key="mid_line_voltage_l2_l3",
        register=51,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID Line Voltage L3 L1",
        key="mid_line_voltage_l3_l1",
        register=52,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID DC Bus Positive Voltage",
        key="mid_dc_bus_positive_voltage",
        register=98,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID DC Bus Negative Voltage",
        key="mid_dc_bus_negative_voltage",
        register=99,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID Output Power Limit Readback",
        key="mid_output_power_limit_readback",
        register=102,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 1 Voltage",
        key="mid_string_1_voltage",
        register=142,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 1 Current",
        key="mid_string_1_current",
        register=143,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 2 Voltage",
        key="mid_string_2_voltage",
        register=144,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 2 Current",
        key="mid_string_2_current",
        register=145,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 3 Voltage",
        key="mid_string_3_voltage",
        register=146,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 3 Current",
        key="mid_string_3_current",
        register=147,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 4 Voltage",
        key="mid_string_4_voltage",
        register=148,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 4 Current",
        key="mid_string_4_current",
        register=149,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 5 Voltage",
        key="mid_string_5_voltage",
        register=150,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 5 Current",
        key="mid_string_5_current",
        register=151,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 6 Voltage",
        key="mid_string_6_voltage",
        register=152,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 6 Current",
        key="mid_string_6_current",
        register=153,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 7 Voltage",
        key="mid_string_7_voltage",
        register=154,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 7 Current",
        key="mid_string_7_current",
        register=155,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 8 Voltage",
        key="mid_string_8_voltage",
        register=156,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    GrowattModbusSensorEntityDescription(
        name="MID String 8 Current",
        key="mid_string_8_current",
        register=157,
        register_type=REG_INPUT,
        allowedtypes=GEN2 | PV | X3 | MPPT4,
        entity_category=EntityCategory.DIAGNOSTIC,
...
SENSOR_TYPES: list[GrowattModbusSensorEntityDescription] = [
    *MID_GEN2_TELEMETRY,
    ...
    # Protocol II uses input 32 for PV8 current, not inverter temperature.
    # GEN2/GEN3 inverter temperature is defined once below at input 93.
    GrowattModbusSensorEntityDescription(
        name="PV Current 8",
        key="pv_current_8",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
...
FIRMWARE_PREFIX_TYPES = {
    ...
    "DM1": PV | GEN2 | X3 | MPPT4,  # MID TL3-X four-MPPT firmware branch (verified on MID 36KTL3-X)
